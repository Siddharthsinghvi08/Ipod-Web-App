...
// Ipod component with ipod css and buttons Functionality
class Ipod extends React.Component{
    ...
    rotateWheel = () => {
        ...
        if(self.state.enter < 2){
            // on rotation iy will calculate the new angle and accordingly it will change the options for our Home page
    ...
    // Changing Page by Clicking Middle Button
    changePage = () => {
    ...
    // Changing Page to home screen by clicking MenuButton
    ...
    // Setting Audio Element while rendering the Component
    componentDidMount(){
